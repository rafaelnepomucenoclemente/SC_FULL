...
{
	CTachyonMesh::m_gZEnable = bZEnable;
	CTachyonMesh::m_gZWriteable = bZWriteable;
}
...
void CTachyonMesh::Render( LPDIRECT3DDEVICE9 pDevice, int nLevel)
{
	...
	pDevice->SetRenderState( D3DRS_ZWRITEENABLE, CTachyonMesh::m_gZWriteable );
	pDevice->SetRenderState( D3DRS_ZENABLE, CTachyonMesh::m_gZEnable );
